...
public class BoardDisplay implements ActionListener
{
	 ...
	 * @param board		The board to construct the the display with
	 */
	 ...
	 * @postcondition	The GUI is created and shown
     */
	...
	/**
	 * Selects or unselects a peice/move when a square is clicked
    ...
    public void actionPerformed(ActionEvent event)
    {
		...
		if (selectedPiece == null)
		{
			...
			if (selectedPiece != null)
				...
				ArrayList<Location> dests = selectedPiece.destinations();
				/*
				for (Location dest : dests)
				{
					setColor(dest, Color.GREEN);
				}
				 */
		}
	 ...
	 * @postcondition	The chess board is showing
	 */
	...
	/**
	 * Sets the color of the tile at a location
	 * @param loc	  The location of the tile to change
	 * @param color   The color to change the tile to
	 * @postcondition Tile at location loc is set to have color color
	 */
	...
	/**
	 * Clears the colors at all tiles
	 * @postcondition	No tiles are colored
	 */
	...
	/**
	 * Ends the current game by showing a game over message
